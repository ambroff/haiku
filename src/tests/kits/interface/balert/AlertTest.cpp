...
AlertTest::twentyX_20X_60X_UW_ES_EA()
{
	...
	bi.width = 160.0f;
	bi.height = 30.0f;
	bi.topleft.Set(7.0f, 51.0f);
	ati.SetButtonInfo(0, bi);
	bi.label = k20X;
	bi.width = 160.0f;
	bi.height = 35.0f;
	bi.topleft.Set(174.0f, 49.0f);
	ati.SetButtonInfo(1, bi);
...
AlertTest::twentyX_OK_Cancel_60X_UW_OS_EA()
{
	...
	bi.width = 75.0f;
	bi.height = 30.0f;
	bi.topleft.Set(248.0f, 51.0f);
	ati.SetButtonInfo(1, bi);
	bi.label = "Cancel";
	bi.width = 75.0f;
	bi.height = 35.0f;
	bi.topleft.Set(330.0f, 49.0f);
	ati.SetButtonInfo(2, bi); 
